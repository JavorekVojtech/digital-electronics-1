...
architecture testbench of tb_cnt_up_down is
  ...
  signal sig_round : std_logic_vector(c_CNT_WIDTH - 1 downto 0); -- Add a round signal
...
begin
  ...
  uut_cnt : entity work.cnt_up_down
    ...
    port map (
      ...
      cnt_up => sig_cnt_up,
      cnt    => sig_cnt,
      round  => sig_round -- Connect the round signal
    );
  ...
  begin
    ...
    while now < 10 us loop             -- 75 periods of 100MHz clock
